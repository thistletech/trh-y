...
trh-y🐚 $ trh --external-sign "trh-y/thistle-bin/sign-y" prepare -t=./rel
...
Executing external signing command
=====
Signing /var/folders/5k/pbgrbj194573msk705r200sc0000gn/T/tmp.47swZ1lw with YubiKey. Touch your YubiKey if it blinks.
=====
